...
# Bubble Aiming
This project maintains the aiming module in [Bubble](https://github.com/Birdiebot/bubble) project.The module contains various packages related to aiming, and implements ballistic compensation, shooting decision-making and prediction functions based on the image processing image information.
