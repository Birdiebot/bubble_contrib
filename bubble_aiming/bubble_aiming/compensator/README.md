...
# Bubble Compensator
This project maintains the aiming module in [Bubble](https://github.com/Birdiebot/bubble) project. The module implements ballistic compensation function, which iterates on compensation and distance based on the information of the pnp solution and the gimbal attitude to obtain the final compensation value more precisely. See the Documentation section for specific algorithm implementation.
