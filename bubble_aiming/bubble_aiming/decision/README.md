...
# Bubble Aiming Decision
This project maintains the aiming module in [Bubble](https://github.com/Birdiebot/bubble) project. This module realizes the decision about aiming in different scenarios based on the start time of the competition, the information of the pnp solution, the gimbal posture and other information. See the Documentation section for specific algorithm implementation.
