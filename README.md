...
# Bubble contribution
This project maintains the relevant functional module in [Bubble](https://github.com/Birdiebot/bubble) project, where the estimation function of the robot is implemented. Refer to the README file under the feature pack for details about the each function modules.
