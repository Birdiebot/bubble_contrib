...
# Bubble debugger
This package maintains the debugger module in [Bubble](https://github.com/Birdiebot/bubble) project, The module converts the target information into rviz format, which can be easily debugged in rviz. In the early release code, we mistakenly wrote "debugger" instead of "debuger", and We will fix this in A future release.
